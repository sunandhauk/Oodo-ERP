  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 sm:py-10">
      <section className="w-full max-w-[720px]">
        <div className="mx-auto flex w-full flex-col items-center rounded-[28px] border border-white/70 bg-white/95 px-5 py-8 shadow-[0_24px_64px_rgba(15,23,42,0.12)] backdrop-blur-sm sm:px-8">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link href="/user-login" className="rounded-[14px] bg-brand-600 px-5 py-3 font-semibold text-white transition hover:bg-brand-700">
              Back to User Login
            </Link>
            <Link href="/login" className="rounded-[14px] border border-brand-200 px-5 py-3 font-semibold text-brand-700 transition hover:bg-brand-50">
